# Agora, passando o diretório para o código de transformação de dados
import pdfplumber
import pandas as pd
import zipfile

PDF_PATH = os.path.join(save_directory, 'Anexo_I_Rol_2021RN_465.2021_RN627L.2024.pdf')  # Defina o caminho completo do PDF
